...
const main = ()=>{
    ...
    mongoose.connection.on("error", ()=>{
        loggerConsola.error("Error al conectarse a la base de datos");
...
class ContenedorMongoDB {
    ...
    async getById(num) {
        try{
            ...
            loggerError.error('Error en getById ' + error)
    ...
    async getAll() {
         try{
            ...
            loggerError.error('Error en getAll ' + error)
            console.log(error)
        };
    ...
    async deleteById(num) {
        try{
            ...
            loggerError.error('Error en deleteById ' + error)
    ...
    async deleteAll() {
        try{
            ...
            loggerError.error('Error en deleteAll ' + error)
